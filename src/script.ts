...
class Stage {
    ...
    add = function(elem: any) {
        this.scene.add(elem);
    }

    remove = function(elem: any) {
...
class Block {
    ...
    dimension: TDimension = { width: 0, height: 0, depth: 0 }
...
class Game {
    ...
    placeBlock() {
        ...
        if ( newBlocks.chopped ) {
            ...
            let positionParams: TPositionParams & Txyz = { y: '-=30', ease: Power1.easeIn, onComplete: () => this.choppedBlocks.remove(newBlocks.chopped) }
